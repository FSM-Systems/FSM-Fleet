...
$(document).ready(function () {
	...
	$("#addquotdet").click(function () {
		$(".quotdet").toggle("slide", {direction: "left"})
	});

	// Button to add quotes
	$("#btnquotdet").click(function () {
		$("#tblquotedet tbody").append("<tr><td>tetetetetetetetetet</td></tr>");
	})
})
</script>
<link rel="stylesheet" href="css/quotations.css" type="text/css">
</head>
<body>
<table>
	<tr>
		<td>
			...
			<form name="newfrm" id="newfrm">
				...
				<button type="button" id="addquotdet">ADD QUOTATION DETAILS</button>
		...
		<td class="quotdet">
			...
			<div style="width: 100%; text-align: center;">
				<button type="button" id="btnquotdet">ADD THIS DETAIL TO QUOTATION</button>
			</div>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="100">
				<div style="text-align: center; width: 100%">
					<input type="button" name="btnnew" id="btnnew" disabled="true" value="CREATE NEW <?php echo $_REQUEST["btntext"]; ?>">
				</div>
		</td>
	</tr>
</table>
